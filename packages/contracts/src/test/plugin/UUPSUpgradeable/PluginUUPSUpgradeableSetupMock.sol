...
import {PluginSetupUpgradeable} from "../../../framework/plugin/setup/PluginSetupUpgradeable.sol";
...
contract PluginUUPSUpgradeableSetupV1Mock is PluginSetupUpgradeable {
    constructor() PluginSetupUpgradeable(address(new PluginUUPSUpgradeableV1Mock())) {}
...
contract PluginUUPSUpgradeableSetupV2Mock is PluginSetupUpgradeable {
    constructor() PluginSetupUpgradeable(address(new PluginUUPSUpgradeableV2Mock())) {}
...
contract PluginUUPSUpgradeableSetupV3Mock is PluginSetupUpgradeable {
    constructor() PluginSetupUpgradeable(address(new PluginUUPSUpgradeableV3Mock())) {}
...
contract PluginUUPSUpgradeableSetupV4Mock is PluginSetupUpgradeable {
    constructor() PluginSetupUpgradeable(address(new PluginUUPSUpgradeableV3Mock())) {}
        ...
        returns (bytes memory initData, PreparedSetupData memory preparedSetupData)
    {
        ...
        // NOTE that dev is free to do what he wishes.
            ...
            (initData, preparedSetupData) = prepareUpdateAlt(_dao, _currentBuild, _payload);
    ...
    function prepareUpdateAlt(
        address _dao,
        uint16 _currentBuild,
        SetupPayload calldata _payload
    ) internal pure returns (bytes memory initData, PreparedSetupData memory preparedSetupData) {
        (_dao, _payload);
