...
- Added an abstract `PluginSetupUpgradeable` base contract.

### Changed

- Added a `address public immutable implementation` variable to `PluginSetup` and `PluginSetupUpgradeable` and removed the `implementation()` functions.
